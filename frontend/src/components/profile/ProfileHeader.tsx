...
export default function ProfileHeader({ username, email, level, points, memberSince }: ProfileHeaderProps) {
  return (
    <div className="relative overflow-hidden rounded-sm bg-[#2D1B14] p-8 shadow-2xl md:p-12">
      ...
      <div className="relative z-10 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
        <div className="flex flex-col items-center gap-5 text-center md:flex-row md:items-end md:text-left">
          <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-4 border-white/10 bg-[#D4AF37] shadow-xl md:h-28 md:w-28">
            <img
