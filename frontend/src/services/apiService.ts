 ...
 *
 * Covers:
 *   - Classic session id lifecycle in browser storage
 *   - Question/hint/answer API calls for Classic Room
 *   - Lightweight backend health probing
 */
...
// Resolve user id from storage, creating fallback id when absent.
...
export const generateQuestion = async (
  ...
  const response = await fetch(`${API_BASE}/api/rooms/classic/questions`, {
    method: 'POST',
    headers: authHeaders(),
    body: JSON.stringify({
...
export const generateHint = async (
  ...
  const response = await fetch(`${API_BASE}/api/rooms/classic/hints`, {
    method: 'POST',
    headers: authHeaders(),
    body: JSON.stringify({
...
export const submitAnswer = async (
  ...
  const response = await fetch(`${API_BASE}/api/rooms/classic/answers`, {
    method: 'POST',
    headers: authHeaders(),
    body: JSON.stringify({
      user_id: getUserId(),
