...
- Consolidate schema modules into one package.
- Proposed move group:
- pydantic_auth.py, pydantic_challenge.py, pydantic_custom.py, pydantic_onboarding.py, pydantic_pvp.py, pydantic_types.py, schemas.py -> schemas/
- Update imports in routers/services/tests to package-based imports.
- Keep temporary compatibility shims only if needed for one sprint, then remove.
