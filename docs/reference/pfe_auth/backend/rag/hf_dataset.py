...
# Topic keywords for filtering HF dataset questions
# Keys are lowercase to match backend's normalized topic values
TOPIC_KEYWORDS = {
    "history": [
    ...
    "mix": [],  # no filter for mixed topics
}
...
async def load_hf_dataset():
    ...
    try:
        ...
        # Fallback: no event loop available (should not happen in FastAPI)
