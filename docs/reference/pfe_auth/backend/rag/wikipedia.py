"""
rag/wikipedia.py â€” Wikipedia API retrieval.
...
# â”€â”€ Difficulty-tiered Wikipedia queries â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def fetch_related_titles(
    ...
    """Fetch related article titles â€” used for distractor generation."""
    try:
        resp = await client.get(
            WIKI_SEARCH,
            headers=HEADERS,
