"""
pydantic_challenge.py — Pydantic request/response models for Challenge Room.

Mirrors the TypeScript interfaces in types/challenge.ts exactly.
Keep these separate from pydantic_types.py (ClassicRoom) — zero coupling.
"""
...
class ChallengeQuestionOut(BaseModel):
    ...
    The frontend uses `points_value` to show how much the question is worth.
    """
    id           : str
    text         : str
    options      : List[str]
