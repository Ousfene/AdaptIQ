...
import { getUserRank, startChallengeSession, submitChallengeAnswer, generateChallengeQuestion } from '../services/challengeService';
...
const ChallengeRoom: React.FC = () => {
  ...
  const handleNextQuestion = async () => {
    ...
    try {
      const nextQ = await generateChallengeQuestion(session.topic, session.current_level, session.session_id);
      setSession(prev => {
        if (!prev) return null;
        return {
          ...prev,
