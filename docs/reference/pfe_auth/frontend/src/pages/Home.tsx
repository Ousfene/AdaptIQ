    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'py-3 bg-[#F5F2E7]/95 backdrop-blur-md border-b border-[#D4AF37]/30 shadow-lg' : 'py-6 bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-8 flex items-center justify-between">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
          <div className="w-12 h-12 bg-[#2D1B14] rounded-sm flex items-center justify-center border border-[#D4AF37] rotate-3 hover:rotate-0 transition-transform shadow-md">
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={() => navigate('/signup')} className="px-6 py-3 text-xs font-bold uppercase tracking-widest button-scholarly flex items-center gap-2 shadow-xl">
    ...
    <section className="relative pt-40 pb-20 md:pt-56 md:pb-40 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10 text-center">
        ...
        <div className="flex justify-center">
          <button onClick={() => navigate('/signup')} className="px-12 py-6 button-scholarly font-bold text-sm uppercase tracking-[0.3em] shadow-2xl hover:scale-105 transition-transform group">
...
const RitualCard = ({ ritual, title, desc, icon }) => (
  <div className="group h-full">
    <div className="relative h-full bg-[#FDFCF7] p-10 border border-[#2D1B14]/10 hover:border-[#D4AF37]/50 transition-all duration-500 shadow-sm hover:shadow-xl flex flex-col">
    ...
    <section id="archives" className="py-32 px-8 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="relative">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="p-6 border border-[#D4AF37]/20 rounded-sm hover:border-[#D4AF37] transition-colors bg-[#FDFCF7]">
          ...
          <div className="relative">
             <div className="relative leather-border bg-[#F5F2E7] p-8 md:p-12 shadow-2xl">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 bg-white border-l-4 border-[#2D1B14] italic text-sm text-[#2D1B14]/70 font-serif">
    ...
    <section id="journey" className="py-32 px-8 bg-[#2D1B14]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {features.map((f, i) => (
            <div key={i} className="p-8 border border-[#F5F2E7]/10 bg-white/5 hover:bg-white/10 transition-all group">
              <div className="w-12 h-12 flex items-center justify-center text-[#D4AF37] mb-6 border border-[#D4AF37]/30 group-hover:bg-[#D4AF37] group-hover:text-[#2D1B14] transition-all">
                {f.icon}
              </div>
