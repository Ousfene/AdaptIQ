...
Run from adaptiq-backend/:
    python.exe ingest_shapes_v2.py
"""
...
GEOJSON_110M = "ne_110m_countries.geojson"   # already downloaded
GEOJSON_50M  = "ne_50m_countries.geojson"    # will download if needed
...
# This maps the REST Countries ISO2 → what Natural Earth actually stores.
ISO2_REMAP = {
