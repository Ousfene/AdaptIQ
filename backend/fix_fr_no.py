...
def main():
    ...
    if not os.path.exists("ne_50m_countries.geojson"):
        download_geojson(GEOJSON_50M_URL, "ne_50m_countries.geojson")
    if not os.path.exists("ne_110m_countries.geojson"):
        download_geojson(GEOJSON_110M_URL, "ne_110m_countries.geojson")
    ...
    geojson_file = None
    for fname in ["ne_50m_countries.geojson", "ne_110m_countries.geojson"]:
