...
Run from backend folder:
    python tests/test_security_regressions_live.py
"""
...
if __name__ != "__main__":
    ...
    pytest.skip("Live integration script; run with python tests/test_security_regressions_live.py", allow_module_level=True)
