...
# â”€â”€â”€ Topic catalogue â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

TOPIC_CATALOGUE = [
    {"type": "History",   "slug": "ww1",              "name": "World War I",           "description": "The Great War (1914â€“1918).",                         "total_facts": 1000},
    {"type": "History",   "slug": "ww2",              "name": "World War II",          "description": "The largest conflict in human history (1939â€“1945).", "total_facts": 1000},
    {"type": "History",   "slug": "cold-war",         "name": "Cold War",              "description": "Geopolitical tension between the US and USSR.",       "total_facts": 1000},
    {"type": "History",   "slug": "ancient-rome",     "name": "Ancient Rome",          "description": "From city-state to empire.",                          "total_facts": 1000},
    {"type": "History",   "slug": "french-rev",       "name": "French Revolution",     "description": "Far-reaching upheaval in France.",                    "total_facts": 1000},
    {"type": "History",   "slug": "ind-rev",          "name": "Industrial Revolution", "description": "New manufacturing processes in Europe and the US.",   "total_facts": 1000},
    {"type": "Geography", "slug": "geo-usa",          "name": "United States",         "description": "Geography of the United States.",                     "total_facts": 500},
    {"type": "Geography", "slug": "geo-brazil",       "name": "Brazil",                "description": "Geography of Brazil.",                                "total_facts": 500},
    {"type": "Geography", "slug": "geo-france",       "name": "France",                "description": "Geography of France.",                                "total_facts": 500},
    {"type": "Geography", "slug": "geo-egypt",        "name": "Egypt",                 "description": "Geography of Egypt.",                                 "total_facts": 500},
    {"type": "Geography", "slug": "geo-china",        "name": "China",                 "description": "Geography of China.",                                 "total_facts": 500},
    {"type": "Geography", "slug": "geo-australia",    "name": "Australia",             "description": "Geography of Australia.",                             "total_facts": 500},
    {"type": "Geography", "slug": "geo-uk",           "name": "United Kingdom",        "description": "Geography of the United Kingdom.",                    "total_facts": 500},
    {"type": "Geography", "slug": "geo-india",        "name": "India",                 "description": "Geography of India.",                                 "total_facts": 500},
    {"type": "Geography", "slug": "geo-japan",        "name": "Japan",                 "description": "Geography of Japan.",                                 "total_facts": 500},
    {"type": "Geography", "slug": "geo-south-africa", "name": "South Africa",          "description": "Geography of South Africa.",                          "total_facts": 500},
]


# â”€â”€â”€ Mastery helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

# Get or initialize mastery progress row for a user/topic pair.
async def get_or_create_mastery(
    db: AsyncSession,
    user_id: uuid.UUID,      # UUID â€” matches users.id
    topic: str,
    total_facts: int,
) -> UserTopicMastery:
...
# â”€â”€â”€ Fact selection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def pick_fact_for_user(
    ...
    mastered_ids_q = await db.execute(
        select(UserFactProgress.fact_id).where(
            ...
            UserFactProgress.is_mastered == True,
        )
    )
...
# â”€â”€â”€ LLM prompt builder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def build_custom_prompt(topic: str, fact_content: str, difficulty_hint: Optional[str]) -> str:
    if difficulty_hint == "easy":
        difficulty_text = "Make this an easy question â€” two of the wrong options should be obviously incorrect."
    elif difficulty_hint == "hard":
        difficulty_text = "Make this a hard question â€” all four options should be plausible to an expert."
    else:
